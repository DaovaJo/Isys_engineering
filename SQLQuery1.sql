...
CREATE TABLE users /*Ïîëüçîâàòåëè*/
(
...
CREATE TABLE dictionary /*Ñëîâàðü*/
(
...
CREATE TABLE messagen /*Ñîîáùåíèÿ, ñòðîêà ââîäà*/
(
...
CREATE TABLE story_chat /*Èñòîðèÿ ÷àòà*/
(
